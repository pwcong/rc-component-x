...
import Transition, { IProps as ITransitionProps } from './transition';

import addOneClass from './utils/add-class';
import removeOneClass from './utils/remove-class';
...
export interface IProps extends ITransitionProps {
  /**
 ...
 */
class CSSTransition extends React.PureComponent<IProps> {
  static defaultProps = {
    classNames: ''
  };
